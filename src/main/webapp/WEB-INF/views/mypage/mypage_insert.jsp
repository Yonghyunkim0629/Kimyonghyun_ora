					...
					<form action="/mypage/insert" class="regForm" method="post">
						<fieldset>
							...
							<ul class="reg_list">
								...
								<div class="reg_content" style="padding-top:10px;">
								...
								<li class="clear">
									...
									<input value="" name="user_pw" type="password" class="w100p" id="user_pw_lbl" placeholder="암호를 입력해주세요."/>
									</div>
								</li>
								<li class="clear">
									<label class="tit_lbl">이름</label>
									<div class="reg_content" style="padding-top:8px;">
									<input required value="${memberVO.user_name}" name="user_name" type="text" class="w100p" placeholder="이름를 입력해주세요."/>
									</div>
								</li>
								<li class="clear">
...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			...
			error:function(){
				alert("아이디체크 RestAPI 서버가 작동하지 않습니다.");
			}
		});	
	});
}); 
